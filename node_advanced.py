...
class TiledImageGeneratorAdvanced:
    """
    ComfyUI node that generates a tiled image composition using custom samplers and guiders.
    Each tile generates at exactly tile_width x tile_height. Neighbor overlap pixels are
    passed to ControlNet as a reference image. Tiles are blended into the canvas with
    linear feathering.
    """
